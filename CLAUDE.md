...
Required in `.env.local`: `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`, `TOUR_API_KEY`, `CAMPING_API_KEY`, `RECIPE_API_KEY`, `WEATHER_API_KEY`, `NEXT_PUBLIC_NAVER_MAP_CLIENT_ID`, `KEPCO_API_KEY`
