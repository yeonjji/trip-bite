...
export default function FacilityCategoryCard({
  ...
  if (comingSoon) {
    return (
      <div className="block rounded-2xl border border-border bg-white p-5 opacity-60 cursor-default">
        {cardContent}
      </div>
    );
  }
  ...
  return (
    <Link
      href={href}
      className="block rounded-2xl border border-border bg-white p-5 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5"
    >
      {cardContent}
    </Link>
  );
