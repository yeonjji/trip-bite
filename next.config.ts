...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(self)" },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co https://apis.data.go.kr https://openapi.map.naver.com https://oapi.map.naver.com https://*.map.naver.com https://*.pstatic.net https://*.nelo.navercorp.com https://naveropenapi.apigw.ntruss.com https://nrbe.pstatic.net",
