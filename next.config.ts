...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(self)" },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://openapi.map.naver.com https://oapi.map.naver.com https://maps.googleapis.com",
      "style-src 'self' 'unsafe-inline' https://oapi.map.naver.com",
      "img-src 'self' data: blob: https: http:",
      "font-src 'self' data: https://oapi.map.naver.com",
      "connect-src 'self' https://*.supabase.co https://apis.data.go.kr https://openapi.map.naver.com https://oapi.map.naver.com https://*.map.naver.com",
      "frame-src 'none'",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
